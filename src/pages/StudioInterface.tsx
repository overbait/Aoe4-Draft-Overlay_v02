...
import DeciderMapElement from '../components/studio/DeciderMapElement';
        ...
        <div style={toolboxSectionStyle}>
         ...
         {openToolboxSections.elements && (
           <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
             ...
             <button onClick={() => addStudioElement("DeciderMap")} style={{ ...buttonStyle, backgroundColor: 'purple', width: 'calc(50% - 5px)' }}>Add Decider Map</button>
           </div>
         )}
        </div>
